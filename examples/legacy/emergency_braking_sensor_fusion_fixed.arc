model EmergencyBrakingSensorFusion {
    ...
    // ========== SYSTEM REQUIREMENTS ==========
    requirements system {
        req SYS_001 "Radar Detection Range" {
        ...
        req SYS_002 "Camera Object Classification" {
        ...
        req SYS_004 "Sensor Fusion Algorithm" {
        ...
        req SYS_007 "Driver Override Detection" {
        ...
        req SYS_008 "Fail-Operational Mode" {
    ...
    requirements safety {
        ...
        req SAF_003 "Fail-Operational Time" {
        ...
        req SAF_004 "Watchdog Monitoring" {
    ...
    traceability {
        ...
        trace STK_001 -> [SYS_001, SYS_005, SYS_006]
        trace STK_002 -> [SYS_001, SYS_002, SYS_003, SYS_004, SYS_008]
        trace STK_003 -> [SYS_007]
        trace STK_004 -> [SYS_005]

        // System to Safety Requirements
        trace SYS_001 -> [SAF_001]
        trace SYS_002 -> [SAF_001]
        trace SYS_003 -> [SAF_001]
        trace SYS_004 -> [SAF_001]
        trace SYS_008 -> [SAF_001, SAF_002, SAF_003]

        // Requirements to Logical Components
        trace SYS_001 -> [RadarSensor]
        trace SYS_002 -> [CameraSensor]
        trace SYS_003 -> [LidarSensor]
        trace SYS_004 -> [SensorFusionSubsystem]
        trace SYS_005 -> [ThreatAssessmentUnit]
        trace SYS_006 -> [BrakingDecisionUnit, BrakeActuatorInterface]
        trace SYS_007 -> [BrakingDecisionUnit]
        trace SYS_008 -> [SafetyMonitor, SensorFusionSubsystem]
        trace SAF_001 -> [RadarSensor, CameraSensor, LidarSensor, SensorFusionSubsystem]
        trace SAF_002 -> [SafetyMonitor]
        trace SAF_003 -> [SafetyMonitor, SensorFusionSubsystem]
        trace SAF_004 -> [SafetyMonitor]
