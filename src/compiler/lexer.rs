...
impl Token {
    ...
    pub fn keyword_text(&self) -> Option<&'static str> {
        let text = match self {
            ...
            Token::Realizes => "realizes",
            Token::Refines => "refines",
            Token::Mission => "mission",
            Token::Capability => "capability",
            Token::FunctionalChain => "functional_chain",
            Token::CapabilityRealization => "capability_realization",
            Token::Involves => "involves",
            Token::StateMachineKw => "state_machine",
            Token::StateKw => "state",
            Token::Mode => "mode",
            ...
            Token::ExchangeItemKw => "exchange_item",
            Token::PhysicalPathKw => "physical_path",
...
impl Lexer {
    ...
    fn read_identifier_or_keyword(&mut self) -> Result<Token, String> {
        ...
        let token = match ident.as_str() {
            ...
            "realizes" => Token::Realizes,
            "refines" => Token::Refines,
            "mission" => Token::Mission,
            "capability" => Token::Capability,
            "functional_chain" => Token::FunctionalChain,
            "capability_realization" => Token::CapabilityRealization,
            "involves" => Token::Involves,
            "state_machine" => Token::StateMachineKw,
            "state" => Token::StateKw,
            "mode" => Token::Mode,
            ...
            "exchange_item" => Token::ExchangeItemKw,
            "physical_path" => Token::PhysicalPathKw,
            "operational_process" => Token::OperationalProcess,
